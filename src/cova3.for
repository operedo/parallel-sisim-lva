...
c
            ...
            h = real(dsqrt(hsqd))
            !write(*,*)'dist',h
            if(x1.eq.0.0.and.y1.eq.0.0.and.z1.eq.0.0.and.x2 
     +      .eq.29.26800.and.y2.eq.-60.20000.and.z2.eq.45.98400)then
            write(*,*)'cov:',h,hsqd
            end if
c
...
c
            ...
            if(x1.eq.0.0.and.y1.eq.0.0.and.z1.eq.0.0.and.x2 
     +      .eq.29.26800.and.y2.eq.-60.20000.and.z2.eq.45.98400)then
            write(*,*)'cov-exp:',cova,cc(ist),aa(ist)
            end if
c
